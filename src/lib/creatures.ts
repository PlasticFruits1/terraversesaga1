...
export const initialCreatures: Creature[] = [
  {
    ...
    abilities: [
      { name: "Vine Whip", type: "attack", power: 15, description: "Lashes out with a thorny vine.", energyCost: 20 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Water Gun", type: "attack", power: 20, description: "Squirts a jet of water.", energyCost: 20 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Peck", type: "attack", power: 22, description: "A quick, sharp peck.", energyCost: 20 },
      { name: "Screech", type: "debuff", description: "A loud screech that lowers opponent's defense.", energyCost: 25 },
      { name: "Quick Attack", type: "attack", power: 18, description: "A speedy charge that always strikes first.", energyCost: 15 }
    ]
  }
];
...
const regularOpponents: Creature[] = [
  {
    ...
    abilities: [
      { name: "Rock Throw", type: "attack", power: 20, description: "Hurls a small rock.", energyCost: 20 },
      { name: "Stone Skin", type: "defense", defenseBoost: 15, description: "Hardens skin, increasing defense.", energyCost: 25 },
      { name: "Tremor", type: "attack", power: 25, description: "A lesser ground-shaking attack.", energyCost: 30 }
    ]
  },
  {
    id: 22,
    ...
    abilities: [
        { name: "Bite", type: "attack", power: 22, description: "A sharp, quick bite.", energyCost: 20 },
        { name: "Aqua Jet", type: "attack", power: 18, description: "Slam into the foe with high speed.", energyCost: 25 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Gust", type: "attack", power: 20, description: "A quick blast of wind.", energyCost: 20 },
        { name: "Tailwind", type: "buff", description: "Raises speed for a few turns.", energyCost: 25 },
        { name: "Air Cutter", type: "attack", power: 28, description: "A sharp blade of wind.", energyCost: 30 }
    ]
  },
    {
    id: 24,
    ...
    abilities: [
        { name: "Scratch", type: "attack", power: 18, description: "A basic scratch attack.", energyCost: 15 },
        { name: "Flame Wheel", type: "attack", power: 30, description: "A fiery spinning tackle.", energyCost: 30 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Poison Sting", type: "attack", power: 22, description: "A venomous jab.", energyCost: 25 },
        { name: "Shadow Sneak", type: "attack", power: 25, description: "Attacks from the shadows.", energyCost: 30 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Shell Smash", type: "attack", power: 25, description: "A powerful body slam.", energyCost: 25 },
        { name: "Solar Beam", type: "attack", power: 40, description: "A concentrated blast of light.", energyCost: 40 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Shadow Claw", type: "attack", power: 30, description: "Slashes with claws of darkness.", energyCost: 25 },
        { name: "Howl", type: "buff", description: "A chilling howl that raises attack.", energyCost: 20 },
        { name: "Bite", type: "attack", power: 22, description: "A standard, vicious bite.", energyCost: 20 }
    ]
  },
  {
    id: 29,
    ...
    abilities: [
        ...
        { name: "Razor Leaf", type: "attack", power: 28, description: "Slices with sharp-edged leaves.", energyCost: 25 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Scald", type: "attack", power: 35, description: "Shoots boiling water.", energyCost: 30 },
        { name: "Aqua Ring", type: "heal", power: 20, description: "Restores a little HP each turn.", energyCost: 35 },
        { name: "Dive", type: "attack", power: 30, description: "Dives then strikes on the next turn.", energyCost: 30 }
    ]
  },
  {
    id: 31,
    ...
    abilities: [
        { name: "Twister", type: "attack", power: 32, description: "Whips up a vicious twister.", energyCost: 30 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Lava Plume", type: "attack", power: 38, description: "A blast of lava.", energyCost: 35 },
        { name: "Rock Polish", type: "buff", description: "Boosts its speed.", energyCost: 20 },
        { name: "Eruption", type: "attack", power: 45, description: "A powerful volcanic eruption.", energyCost: 40 }
    ]
  },
  {
    id: 33,
    ...
    abilities: [
        ...
        { name: "Horn Drill", type: "attack", power: 40, description: "A powerful, focused horn attack.", energyCost: 35 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Fissure", type: "attack", power: 45, description: "Slams the ground, splitting it open.", energyCost: 40 },
      { name: "Body Press", type: "attack", power: 38, description: "A heavy slam using its immense defense.", energyCost: 35 },
  ...
  },
  {
    ...
    abilities: [
      ...
      { name: "Spike Cannon", type: "attack", power: 35, description: "Fires sharp coral spikes at the foe.", energyCost: 35 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Thunderbolt", type: "attack", power: 50, description: "A powerful bolt of lightning strikes the foe.", energyCost: 40 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Flare Blitz", type: "attack", power: 55, description: "A reckless, full-body fire tackle.", energyCost: 45 },
      { name: "Scary Face", type: "debuff", description: "Intimidates the foe to lower their speed.", energyCost: 20 },
      { name: "Fire Fang", type: "attack", power: 40, description: "A bite attack wreathed in flames.", energyCost: 35 },
    ],
  },
  {
    id: 38,
    ...
    abilities: [
      ...
      { name: "Bear Hug", type: "attack", power: 45, description: "A crushing hug that deals heavy damage.", energyCost: 40 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Moonbeam", type: "attack", power: 45, description: "A concentrated blast of moonlight.", energyCost: 35 },
  ...
  },
  {
    ...
    abilities: [
      ...
      { name: "Abyssal Grasp", type: "attack", power: 50, description: "Tendrils of shadow constrict the foe.", energyCost: 40 },
      { name: "Dark Pulse", type: "attack", power: 40, description: "An aura of dark energy is released.", energyCost: 35 },
    ],
  },
  {
    id: 41,
    ...
    abilities: [
      { name: "Sandstorm", type: "attack", power: 35, description: "Whips up a blinding sandstorm.", energyCost: 30 },
      { name: "Double Team", type: "defense", defenseBoost: 20, description: "Creates illusory copies to boost defense.", energyCost: 25 },
      { name: "Phantom Claw", type: "attack", power: 45, description: "A swift slash that seems to pass through defenses.", energyCost: 35 },
    ],
  },
];
...
const bossCreatures: Creature[] = [
    ...
    abilities: [
        { name: "Tackle", type: "attack", power: 30, description: "A basic tackle.", energyCost: 20 },
        { name: "Fortify", type: "defense", defenseBoost: 25, description: "Greatly raises defense.", energyCost: 30 },
        { name: "Earthquake", type: "attack", power: 55, description: "A devastating ground-shaking attack.", energyCost: 45 }
    ]
  },
  {
    id: 102,
    ...
    abilities: [
        { name: "Tidal Wave", type: "attack", power: 40, description: "A huge wave crashes down.", energyCost: 30 },
        { name: "Regenerate", type: "heal", power: 30, description: "Recovers a good amount of HP.", energyCost: 35 },
        { name: "Dragon Pulse", type: "attack", power: 50, description: "A powerful draconic blast.", energyCost: 40 }
    ]
  },
  {
    id: 103,
    ...
    abilities: [
        { name: "Drill Peck", type: "attack", power: 45, description: "A powerful, spinning beak attack.", energyCost: 30 },
        { name: "Thunder", type: "attack", power: 60, description: "A massive bolt of lightning.", energyCost: 45 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Scorching Bite", type: "attack", power: 45, description: "A vicious, fiery bite.", energyCost: 30 },
        { name: "Howl", type: "buff", description: "Raises its own attack stat.", energyCost: 20 },
        { name: "Hellfire", type: "attack", power: 65, description: "Engulfs the foe in black flames.", energyCost: 50 }
    ]
  },
  {
    id: 105,
    ...
    abilities: [
        { name: "Time Rift", type: "attack", power: 55, description: "Tears a hole in time to strike.", energyCost: 40 },
  ...
  },
  {
    ...
    abilities: [
        { name: "Abyssal Grasp", type: "attack", power: 60, description: "Tendrils of shadow lash out.", energyCost: 40 },
        { name: "Consume Light", type: "heal", power: 40, description: "Drains life from the opponent.", energyCost: 45 },
        { name: "Oblivion", type: "attack", power: 75, description: "A blast of pure void energy.", energyCost: 55 }
    ]
  },
  {
    id: 107,
    ...
    abilities: [
        { name: "Prismatic Wave", type: "attack", power: 65, description: "Unleashes a wave of mixed elemental energy.", energyCost: 45 },
        { name: "Elemental Shift", type: "defense", defenseBoost: 40, description: "Changes its resistance by shifting elements.", energyCost: 35 },
        { name: "Core Eruption", type: "attack", power: 85, description: "The ultimate elemental blast.", energyCost: 65 }
    ]
  },
  {
    id: 108,
    ...
    abilities: [
      { name: "Supernova", type: "attack", power: 80, description: "An explosive blast of solar energy.", energyCost: 60 },
  ...
  },
  {
    ...
    abilities: [
      { name: "Nightfall", type: "attack", power: 70, description: "Plunges the battlefield into darkness, damaging the foe.", energyCost: 55 },
